	...
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			$.scriptcam.SC_addChatText=function(value) {
				value = value.replace(":{", '<img src="'+data.path+'images/angry.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-{", '<img src="'+data.path+'images/angry.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":)", '<img src="'+data.path+'images/smile.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-)", '<img src="'+data.path+'images/smile.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":D", '<img src="'+data.path+'images/biggrin.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-D", '<img src="'+data.path+'images/biggrin.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":O", '<img src="'+data.path+'images/ohmy.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-O", '<img src="'+data.path+'images/ohmy.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":(", '<img src="'+data.path+'images/sad.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-(", '<img src="'+data.path+'images/sad.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":p", '<img src="'+data.path+'images/tongue.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(":-p", '<img src="'+data.path+'images/tongue.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(";)", '<img src="'+data.path+'images/wink.gif" width="16" height="16" class="smiley"/>');
				value = value.replace(";-)", '<img src="'+data.path+'images/wink.gif" width="16" height="16" class="smiley"/>');
