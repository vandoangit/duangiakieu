...
class M_category_news extends CI_Model{

	private $_table="category_news";
	...
	/* ------------------------- Show one Category News ------------------------
	  | Param:menu_class,cate_id,cate_lang
	  | Result:return information of Category News
	  |
	  | //Admin
	  |
	  ----------------------------------------------------------------------- */

	public function get_category_news($cate_id,$menu_class,$cate_lang){
	...
	public function get_category_news_public($cate_id,$menu_class,$cate_lang){
	...
	/* ------------------------ Show Category News Root ------------------------
	  | Param:menu_class,cate_lang
	  | Result:return information of Category News Root
	  |
	  | //Admin
	  |
	  ----------------------------------------------------------------------- */

	public function list_category_news_root($menu_class,$cate_lang){
	...
	public function list_category_news_root_public($menu_class,$cate_lang){
	...
	/* ----------------------- Show Category News of Menu ----------------------
	  | Param:menu_class,cate_lang,update(cate_id)
	  | Result:return information Category News of Menu
	  |
	  | //Admin
	  |
	  ----------------------------------------------------------------------- */

	public function list_category_news_one_menu_admin($menu_class,$cate_lang,$update=false){
	...
	public function list_category_news_one_menu_admin_public($menu_class,$cate_lang,$update=false){
	...
	public function insert_category_news($arr_data){
	...
	public function update_category_news($arr_data,$arr_where){
	...
	public function delete_category_news($arr_where,$table_class=false){
		...
		$query=$this->db->get($this->_table);
		$arr_category_news=$query->result_array();

		$this->db->where($arr_where);
		if($this->db->delete($this->_table) === false)
			return false;

		if($arr_category_news){

			foreach($arr_category_news as $key=> $value){
				if($table_class !== false){

					$arr_where_temp=array('cate_id'=>$value['cate_id']);
					$this->m_news->delete_news($arr_where_temp);
				}

				$arr_where_temp=array('cate_parent'=>$value['cate_id']);
				$this->delete_category_news($arr_where_temp,$table_class);
			}
		}
		return true;
	...
	public function get_category_news_id($cate_id,$cate_lang,$result=''){
		...
		if(is_array($arr_result)){
			...
			foreach($arr_result as $key=> $value){
				$result=$this->get_category_news_id($value['cate_id'],$cate_lang,$result);
			}
		}
		return $result;
	...
	public function get_category_news_id_public($cate_id,$cate_lang,$result=''){
		...
		if(is_array($arr_result)){
			...
			foreach($arr_result as $key=> $value){
				$result=$this->get_category_news_id_public($value['cate_id'],$cate_lang,$result);
			}
		}
		return $result;
	...
	/* ----------------------- Show Category Add Category ----------------------
	  | Param:arr_category_news,parent_id,field_name,field_value,level,str_add
	...
	public function recursive_category_news_level($arr_category_news,$parent_id,$field_name,$field_value,$level=true,$str_add='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',$result='',$number_loop=0){
		...
		if(($number_loop <= $level - 1) || ($level === true)){
			...
			foreach($arr_category_news as $key=> $value){
				if(element('cate_parent',$value,'') == $parent_id){
					...
					$result.=$this->recursive_category_news_level($arr_category_news,element('cate_id',$value,''),$field_name,$field_value,$level,$str_add,$temp_string,$number_loop);
				}
			}
		}
		return $result;
	...
	/* ------------------------- Show Category Add News ------------------------
	  | Param:arr_category_news,parent_id,field_name,field_value,str_add
	  | Result:return string category add news
	  |
	  | //Admin
	  |
	  ----------------------------------------------------------------------- */

	public function recursive_category_news_add($arr_category_news,$parent_id,$field_name,$field_value,$str_add='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',$result='',$number_loop=0){
		...
		foreach($arr_category_news as $key=> $value){
			if(element('cate_parent',$value,'') == $parent_id){
				...
				$result.=$this->recursive_category_news_add($arr_category_news,element('cate_id',$value,''),$field_name,$field_value,$str_add,$temp_string,$number_loop);
			}
		}
		return $result;
	...
	/* ------------------------ Show Category Table News -----------------------
	  | Param:arr_data,parent_id,limit_x,limit_y,str_add
	  | Result:return string table news
	  |
	  | //Admin
	  |
	  ----------------------------------------------------------------------- */

	public function recursive_category_news_table($arr_data,$parent_id,$str_add='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',$result=array('content'=>'','count_record'=>0),$number_loop=0){
		...
		if(is_array(element('category_news',$arr_data,''))){

			foreach(element('category_news',$arr_data,'') as $key=> $value){
				if(element('cate_parent',$value,'') == $parent_id){

					unset($arr_data['category_news'][$key]);
					...
					$temp_string['content']="
                        <tr class='gradeC'>
							...
							<td>
								<div align='center'>
									<a class='lightbox_admin'  rel='category_news' href='".base_src_img(element('cate_img',$value,''))."'>
					...
					$result_temp=$this->recursive_category_news_table($arr_data,element('cate_id',$value,''),$str_add,$temp_string,$number_loop);
	...
	public function get_category_news_front_end($cate_id,$menu_class,$cate_lang){
	...
	public function get_category_news_id_front_end($cate_id,$cate_lang,$result=''){
		...
		if(is_array($arr_result)){
			...
			foreach($arr_result as $key=> $value){
				$result=$this->get_category_news_id_front_end($value['cate_id'],$cate_lang,$result);
			}
		}
		return $result;
	...
	public function list_category_news_root_front_end($menu_class,$cate_lang){
	...
	public function list_category_news_one_menu_admin_front_end($menu_class,$cate_lang){
	...
	/* ------------------------- Show all Category News ------------------------
	  | Param:cate_lang
	  | Result:return information all Category News
	  |
	  | //Front-end
	  |
	  ----------------------------------------------------------------------- */

	public function list_category_news_front_end($cate_lang){
	...
	public function recursive_category_news_front_end($arr_category_news,$parent_id,$field_name,$field_value,$str_add='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',$result='',$number_loop=0){
		...
		foreach($arr_category_news as $key=> $value){
			if(element('cate_parent',$value,'') == $parent_id){
				...
				$result.=$this->recursive_category_news_front_end($arr_category_news,element('cate_id',$value,''),$field_name,$field_value,$str_add,$temp_string,$number_loop);
			}
		}
		return $result;
