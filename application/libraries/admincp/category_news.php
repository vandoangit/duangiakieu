...
Class Category_news{
	...
	public function __construct(){
		...
		$this->_object_category->load->Model(array('m_category_news'));  //my_layout:m_authorization_group,m_sub_menu_admin
	...
	public function category(){
		...
		if($this->_object_category->m_authorization_group->check_authorization_one_menu($this->_menu_class,'category')){
			...
			$this->_arr_data['data_content']['category_news']=$this->_object_category->m_category_news->list_category_news_one_menu_admin($this->_menu_class,$this->_object_category->my_layout->sess_lang_admin);

			if($get_select_filter != 'all'){

				$category_news=$this->_object_category->m_category_news->recursive_category_news_table($this->_arr_data['data_content'],$get_select_filter);
				$this->_arr_data['data_content']['table_content_category_news']=$category_news['content'];
			}
			else{

				$category_news=$this->_object_category->m_category_news->recursive_category_news_table($this->_arr_data['data_content'],0);
				$this->_arr_data['data_content']['table_content_category_news']=$category_news['content'];
			}
			...
			if(isset($_POST[md5('hominhtri')]) && ($_POST[md5('hominhtri')] == 'false')){
				...
				$this->_object_category->load->view(ADMIN_DIR_ROOT."/view_category_news_manager",$this->_arr_data['data_content']);
			}
			else{

				$this->_arr_data['data_content']['category_news_root']=$this->_object_category->m_category_news->list_category_news_root($this->_menu_class,$this->_object_category->my_layout->sess_lang_admin);
				...
				$this->_arr_data['template_view_content']=ADMIN_DIR_ROOT."/view_category_news_manager";
	...
	public function update_category_order(){
		...
		if(isset($_POST[md5('hominhtri')]) && ($_POST[md5('hominhtri')] == 'false')){
			...
			if($this->_object_category->m_authorization_group->check_authorization_one_menu($this->_menu_class,'upcategory')){
				...
				if(!$this->_object_category->m_category_news->update_category_news($arr_data,$arr_where))
					echo "is_numeric";
				else
	...
	public function update_category_public(){
		...
		if(isset($_POST[md5('hominhtri')]) && ($_POST[md5('hominhtri')] == 'false')){
			...
			$category_news=$this->_object_category->m_category_news->get_category_news($this->_object_category->uri->segment(4,true),$this->_menu_class,$this->_object_category->my_layout->sess_lang_admin);
			if($this->_object_category->m_authorization_group->check_authorization_one_menu($this->_menu_class,'upcategory') && is_array($category_news)){

				if(element('cate_public',$category_news,'') == 1)
	...
	public function addcategory(){
		...
		if($this->_object_category->m_authorization_group->check_authorization_one_menu($this->_menu_class,'addcategory')){
			...
			if((isset($_POST['action_form'])) && ($_POST['action_form'] == 'add_category_news') && ($this->_object_category->form_validation->run('add_update_category_news'))){
				...
				$arr_data['cate_parent']=$this->_object_category->input->post('txt_category_news',true);
				...
				if($this->_object_category->m_category_news->insert_category_news($arr_data)){

					if($this->_arr_data['data_content']['authorization']['category']){

						$this->_object_category->session->set_flashdata('add_update_category_news',alert(lang('message_add_success')));
			...
			$arr_category_news=$this->_object_category->m_category_news->list_category_news_one_menu_admin($this->_menu_class,$this->_object_category->my_layout->sess_lang_admin);
			if(is_array($arr_category_news))
				$this->_arr_data['data_content']['category_news']=$this->_object_category->m_category_news->recursive_category_news_level($arr_category_news,0,'txt_category_news',false,$this->_level_menu);

			$this->_arr_data['data_content']['info_content']=$this->_object_category->language->get_data_category_add_update('add_category_news',$this->_level_menu);
			$this->_arr_data['data_content']['info_content']['message_session_flash']=(isset($message_session_flash)) ? $message_session_flash : '';
			$this->_arr_data['template_view_content']=ADMIN_DIR_ROOT."/view_add_update_category_news";
	...
	public function delete_category(){
		...
		if(isset($_POST[md5('hominhtri')]) && ($_POST[md5('hominhtri')] == 'false')){
			...
			if($this->_object_category->m_authorization_group->check_authorization_one_menu($this->_menu_class,'delcategory')){
				...
				if(!$this->_object_category->m_category_news->delete_category_news($arr_where_delete,$this->_table_class))
					echo "delete_faild";
				else
					$this->category();
			}
	...
	public function upcategory(){
		...
		$this->_arr_data['data_content']['category_news_one']=$this->_object_category->m_category_news->get_category_news($this->_object_category->uri->segment(4,true),$this->_menu_class,$this->_object_category->my_layout->sess_lang_admin);

		if($this->_object_category->m_authorization_group->check_authorization_one_menu($this->_menu_class,'upcategory') && is_array($this->_arr_data['data_content']['category_news_one']) && !empty($this->_arr_data['data_content']['category_news_one'])){
			...
			if((isset($_POST['action_form'])) && ($_POST['action_form'] == 'update_category_news') && ($this->_object_category->form_validation->run('add_update_category_news'))){
				...
				if($this->_object_category->m_category_news->update_category_news($arr_data,$arr_where)){
					...
					if($this->_arr_data['data_content']['authorization']['category']){
						...
						$this->_object_category->session->set_flashdata('add_update_category_news',alert(lang('message_update_success')));
						redirect(base_url().ADMIN_DIR_VIRTUAL."/".element('menu_class',$this->_arr_data['data_content']['sub_menu']['category'],false)."/".element('sub_menu_function',$this->_arr_data['data_content']['sub_menu']['category'],false));
					}
					else{
			...
			$this->_arr_data['data_content']['category_news']='';
			$arr_category_news=$this->_object_category->m_category_news->list_category_news_one_menu_admin($this->_menu_class,$this->_object_category->my_layout->sess_lang_admin,element('cate_id',$this->_arr_data['data_content']['category_news_one'],''));
			if(is_array($arr_category_news))
				$this->_arr_data['data_content']['category_news']=$this->_object_category->m_category_news->recursive_category_news_level($arr_category_news,0,'txt_category_news',element('cate_parent',$this->_arr_data['data_content']['category_news_one'],''),$this->_level_menu);

			$this->_arr_data['data_content']['info_content']=$this->_object_category->language->get_data_category_add_update('update_category_news',$this->_level_menu);
			$this->_arr_data['data_content']['info_content']['message_session_flash']=(isset($message_session_flash)) ? $message_session_flash : '';
			$this->_arr_data['template_view_content']=ADMIN_DIR_ROOT."/view_add_update_category_news";
