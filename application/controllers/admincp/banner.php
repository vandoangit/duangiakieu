...
class Banner extends CI_Controller{
	...
	public function __construct(){
		...
		$display_advertise=array('category'=>false,'active'=>true);
		$this->category_sub->set_config_category('banner','advertise',$this->advertises->set_config_advertise('banner',$display_advertise),1);
