...
class Slider extends CI_Controller{
	...
	public function __construct(){
		...
		$display_advertise=array('category'=>false,'active'=>false);
		$this->category_sub->set_config_category('slider','advertise',$this->advertises->set_config_advertise('slider',$display_advertise),1);
