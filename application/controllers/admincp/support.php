...
class Support extends CI_Controller{
	...
	public function __construct(){
		...
		$display_support=array('category'=>true,'info'=>true);
		$this->category_sub->set_config_category('support','support',$this->supports->set_config_support('support',$display_support),1);
