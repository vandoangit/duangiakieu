...
<div id="content">
        ...
        <div class="title_admin_body_left">
            <div class="title_admin_body_right">
                ...
                <div class="title_admin_content_right">
                    ...
                    <?php
                    if(is_array($category_product_root) && !empty($category_product_root)){
                    ?>    
                    <span><?php echo $info_content['cate_control_filter'];?></span>
                    <select name="select_categroy_product" class="ajax_select_filter">
                        <option value="all">&nbsp;&nbsp;&nbsp;<?php echo $info_content['option_select_all'];?></option>
                        <?php                            
                        for($i=0;$i<count($category_product_root);$i++){
                        ?>
                            <option value="<?php echo element('cate_id',$category_product_root[$i],'') ?>" <?php if($this->uri->segment(4,'all')==element('cate_id',$category_product_root[$i],'')) echo "selected" ?>>&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo element('cate_name',$category_product_root[$i],'');?></option>
                        <?php
                        }
                        ?>
                    </select>
    ...
    <form name="form_manager_content" id="form_manager_content" action="" method="post">
        ...
        echo $table_content_category_product;
