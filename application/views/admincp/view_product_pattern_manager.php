...
?>
<script type="text/javascript" src="<?php echo base_url().ADMIN_DIR_TEMPLATE;?>js/ajax/product_pattern.js"></script>
    ...
    (function($){
        ...
        $.alert_authorization_body = function(){
            ...
            $('#content').delegate('#content .alert_authorization_add','click', function(){
                alert("<?php echo $info_content['alert_authorization_add_product_pattern'];?>");
                return false;
            });
        
            $('#content').delegate('#content .alert_authorization_delete','click', function(){
                alert("<?php echo $info_content['alert_authorization_delete_product_pattern'];?>");
                return false;
            });
        
            $('#content').delegate('#content .alert_authorization_update','click', function(){
                alert("<?php echo $info_content['alert_authorization_update_product_pattern'];?>");
                return false;
            });
            return this;
      };  
...
<div id="content">
    ...
    <form name="form_manager_content" id="form_manager_content" action="" method="post">
        ...
        <tr>
            ...
            <th width="340"><?php echo $info_content['product_pattern_name']?></th>

            <th width="140"><?php echo $info_content['product_pattern_create_date'] ?></th>

            <th width="140"><?php echo $info_content['product_pattern_update_date'] ?></th>
            
            <th width="60"><?php echo $info_content['product_pattern_order'] ?></th>
        ...
        <tr>
            ...
            <th><?php echo $info_content['product_pattern_name']?></th>

            <th><?php echo $info_content['product_pattern_create_date'] ?></th>
            
            <th><?php echo $info_content['product_pattern_update_date'] ?></th>
            
            <th><?php echo $info_content['product_pattern_order'] ?></th>
        ...
        if(is_array($product_pattern)){
            ...
            for($i=0;$i<count($product_pattern);$i++){
            ?>
            <tr class="gradeC">
                <td>
                    <div align="center" class="title_table_database">
                        <?php echo element('product_pattern_id',$product_pattern[$i],'');?>
                    </div>
                </td>
                
                <td>
                    <div align="center">
                        <input type="checkbox" name="checkbox[<?php echo element('product_pattern_id',$product_pattern[$i],'');?>]" class="chkCheck" id="check_<?php echo element('product_pattern_id',$product_pattern[$i],'');?>" />
                    </div>
                </td>
                    
                <td>
                    <div align="left" class="title_table_database">
                        <?php echo element('product_pattern_name',$product_pattern[$i],'');?>
                    </div>
                </td>
                
                <td>
                    <div align="center">
                        <?php echo date('d-m-Y H:i:s',strtotime(element('product_pattern_create_date',$product_pattern[$i],'')));?>
                    </div>
                </td>
                
                <td>
                    <div align="center">
                        <?php echo date('d-m-Y H:i:s',strtotime(element('product_pattern_update_date',$product_pattern[$i],'')));?>
                    </div>
                </td>
                
                <td>
                    <?php
                        echo ($authorization['update'])?"<div align='center' class='ajax_update_order_input' update_order_param='".element('product_pattern_id',$product_pattern[$i],'')."' >".element('product_pattern_order',$product_pattern[$i],'')."</div> "
                                                       :"<div align='center'>".element('product_pattern_order',$product_pattern[$i],'')."</div>";
                    ?>
                </td>
                
                <td>
                    <div align="center">
                        <a class="<?php echo ($authorization['update'])?"":"alert_authorization_update" ?>" title="<?php echo $info_content['action_update']?>" href="<?php echo ($authorization['update'])?base_url().ADMIN_DIR_VIRTUAL."/".element('menu_class',$sub_menu['update'],false)."/".element('sub_menu_function',$sub_menu['update'],false)."/".element('product_pattern_id',$product_pattern[$i],''):"#";?>">
                ...
                <td>
                    <div align="center">
                        <a delete_param="<?php echo element('product_pattern_id',$product_pattern[$i],'') ?>" class="<?php echo ($authorization['delete'])?"ajax_delete_item":"alert_authorization_delete"?>" title="<?php echo $info_content['action_delete']?>">
