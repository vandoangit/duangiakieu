    ...
    <div class="function_admin_body">
        <div class="function_admin_body_left">
            <div class="function_admin_body_right">
                <?php echo ($authorization['email'])?"<a class='back_button_all_admin_site' title='".$info_content['action_back']."' href='".base_url().ADMIN_DIR_VIRTUAL."/".element('menu_class',$sub_menu['email'],false)."/".element('sub_menu_function',$sub_menu['email'],false)."'>".$info_content['action_back']."</a>":""?>
    ...
    <fieldset class="fieldset_title_add">
        ...
        <ul class="ul_content_add_user">
            ...
            <li>
                ...
                <input name="txt_support_name" id="txt_support_name" type="text" value="<?php echo set_value('txt_support_name',($info_content['action_name']=='update_support_other')?element('support_name',$support_other,''):""); ?>" class="validate[custom_vi[custom_vi_user_name]] input_text_add" /><?php echo form_error('txt_support_name')?>
            </li>
            
            <li>
                <label class="label_content_add"><?php echo $info_content['support_nick'];?></label>
                <input name="txt_support_nick" id="txt_support_nick" type="text" value="<?php echo set_value('txt_support_nick',($info_content['action_name']=='update_support_other')?element('support_nick',$support_other,''):""); ?>" class="input_text_add" /><?php echo form_error('txt_support_nick')?>
            </li>
            ...
            <li>
                ...
                <select name="txt_support_public" id="txt_support_public" class="select_text_add">
                    <option value="1" <?php echo set_select('txt_support_public','1',(($info_content['action_name']=='update_support_other')&&(element('support_public',$support_other,'')==1))?TRUE:FALSE);?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_public'];?></option>
                    <option value="0" <?php echo set_select('txt_support_public','0',(($info_content['action_name']=='update_support_other')&&(element('support_public',$support_other,'')==0))?TRUE:FALSE);?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_hidden'];?></option>
                </select>
            </li>
            
            <li>
                <label class="label_content_add"><?php echo $info_content['support_order'];?></label>
                <input name="txt_support_order" id="txt_support_order" type="text" value="<?php echo set_value('txt_support_order',($info_content['action_name']=='update_support_other')?element('support_order',$support_other,''):""); ?>" class="validate[required,custom[custom_onlyNumber]] input_text_add" /><?php echo form_error('txt_support_order')?>
            </li>
