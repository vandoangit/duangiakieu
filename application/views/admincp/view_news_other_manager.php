    ...
    <div id="content">
            ...
            <div class="title_admin_body_left">
                <div class="title_admin_body_right">
                    ...
                    <div class="title_admin_content_right">
                        ...
                        <select name="select_category_news_other" class="ajax_select_filter">
        ...
        <div class="function_admin_body">
            <div class="function_admin_body_left">
                ...
                <?php
                    echo "<a class='add_all_admin_site' title='".$info_content['action_add']."' href='".base_url().ADMIN_DIR_VIRTUAL."/".element('menu_class',$sub_menu['article'],false)."/addarticle'>".$info_content['action_add']."</a>";
        ...
        <form name="form_manager_content" id="form_manager_content" action="" method="post">
            ...
            <input type="hidden" id="hidden_input_update"       value="<?php echo element('menu_class',$sub_menu['article'],false)."/uparticle" ?>"/>
            ...
            if(is_array($news_other)){

                for($i=0;$i<count($news_other);$i++){
                ?>
                <tr class="gradeC">
                    <td>
                        <div align="center" class="title_table_database">
                            <?php echo element('news_id',$news_other[$i],'');?>
                        </div>
                    </td>

                    <td>
                        <div align="center">
                            <input type="checkbox" name="checkbox[<?php echo element('news_id',$news_other[$i],'');?>]" class="chkCheck" id="check_<?php echo element('news_id',$news_other[$i],'');?>" />
                        </div>
                    </td>

                    <td>
						<?php
						if(element('news_headline',$news_other[$i],'')!=''){
						?>
						<div align="left" class="content_article">
							<h2 class="title_article"><a title="<?php echo custom_htmlspecialchars(element('news_name',$news_other[$i],'')) ?>" href="#" target="_blank">
								<?php echo element('news_name',$news_other[$i],'') ?>
							</a></h2>
							<?php if(element('news_img',$news_other[$i],'')!=''){ ?>

							<a class="img_article" title="<?php echo custom_htmlspecialchars(element('news_name',$news_other[$i],'')) ?>"  href="#">
								<img align="left" alt="<?php echo custom_htmlspecialchars(element('news_name',$news_other[$i],'')) ?>" src="<?php echo base_src_img(element('news_img',$news_other[$i],'')); ?>"/>
							</a>
							<?php
							}
							echo cut_string_vi(element('news_headline',$news_other[$i],''),500);
							?>
						</div>
						<p class="content_news_author"><?php echo element('news_author',$news_other[$i])?></p>
						<?php
						}
						else{
						?>
                    ...
                    <td>
                        <div align="center">
                            <?php echo element('cate_name',$news_other[$i],''); ?>
                        </div>
                    </td>
                    <?php }
                    ...
                    <td>
                        <?php
                            $active=(element('news_active',$news_other[$i],'')==1)?"ajax_active":"ajax_inactive";
                            echo "<div align='center' class='".$active." ajax_update_active' update_active_param='".element('news_id',$news_other[$i],'')."' cate_id='".element('cate_id',$news_other[$i],'')."'>&nbsp;</div>";
                        ?>
                    </td>
                    <?php } ?>
                    ...
                    <td>
                        <div align="center">
                            <?php echo element('news_view',$news_other[$i],''); ?>
                        </div>
                    </td>

                    <td>
                        <?php
                            $public=(element('news_public',$news_other[$i],'')==1)?"ajax_public_yes":"ajax_public_no";
                            echo "<div align='center' class='".$public." ajax_update_public' update_public_param='".element('news_id',$news_other[$i],'')."' >&nbsp;</div>";
                        ?>
                    </td>

                    <td>
                        <?php
                            echo "<div align='center' class='ajax_update_order_input' update_order_param='".element('news_id',$news_other[$i],'')."' >".element('news_order',$news_other[$i],'')."</div>";
                        ?>
                    </td>

                    <td>
                        <div align="center">
                            <a title="<?php echo $info_content['action_update']?>" href="<?php echo base_url().ADMIN_DIR_VIRTUAL."/".element('menu_class',$sub_menu['article'],false)."/uparticle/".element('news_id',$news_other[$i],''); ?>">
                    ...
                    <td>
                        <div align="center">
                            <a delete_param="<?php echo element('news_id',$news_other[$i],'') ?>" class="ajax_delete_item" title="<?php echo $info_content['action_delete']?>">
