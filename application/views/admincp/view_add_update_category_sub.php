			...
			<fieldset class="fieldset_title_add">
				...
				<ul class="ul_content_add_user">
					<li <?php echo (($info_content['level_menu'] <= 1) && ($info_content['level_menu'] !== true)) ? "style='display:none'" : "" ?>>
						...
						<select name="txt_category_sub" id="txt_category_sub" class="select_text_add">
							<option value="0">&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['select_cate_root']; ?></option>
							<?php echo $category_sub; ?>  
						</select><?php echo form_error('txt_category_sub') ?>
					</li>

					<li>
						<label class="label_content_add"><?php echo $info_content['cate_name']; ?></label>
						<input name="txt_cate_name" id="txt_cate_name" type="text" value="<?php echo set_value('txt_cate_name',($info_content['action_name'] == 'update_category_sub') ? element('cate_name',$category_sub_one,'') : ""); ?>" class="validate[required] input_text_add" /><?php echo form_error('txt_cate_name') ?>
					</li>

					<li>
						<label class="label_content_add"><?php echo $info_content['cate_alias']; ?></label>
						<input name="txt_cate_alias" id="txt_cate_alias" type="text" value="<?php echo set_value('txt_cate_alias',($info_content['action_name'] == 'update_category_sub') ? element('cate_alias',$category_sub_one,'') : ""); ?>" class="validate[required] input_text_add" /><?php echo form_error('txt_cate_alias') ?>
					</li>
					...
					<li>
						...
						<select name="txt_cate_public" id="txt_cate_public" class="select_text_add">
							<option value="1" <?php echo set_select('txt_cate_public','1',(($info_content['action_name'] == 'update_category_sub') && (element('cate_public',$category_sub_one,'') == 1)) ? TRUE : FALSE); ?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_public']; ?></option>
							<option value="0" <?php echo set_select('txt_cate_public','0',(($info_content['action_name'] == 'update_category_sub') && (element('cate_public',$category_sub_one,'') == 0)) ? TRUE : FALSE); ?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_hidden']; ?></option>
						</select>
					</li>

					<li>
						<label class="label_content_add"><?php echo $info_content['cate_order']; ?></label>
						<input name="txt_cate_order" id="txt_cate_order" type="text" value="<?php echo set_value('txt_cate_order',($info_content['action_name'] == 'update_category_sub') ? element('cate_order',$category_sub_one,'') : ""); ?>" class="validate[required,custom[custom_onlyNumber]] input_text_add" /><?php echo form_error('txt_cate_order') ?>
					</li>
