			...
			<fieldset class="fieldset_title_add">
				...
				<ul class="ul_content_add">
					...
					<li>
						...
						<input name="txt_news_name" id="txt_news_name" type="text" value="<?php echo set_value('txt_news_name',($info_content['action_name'] == 'update_news') ? element('news_name',$news,'') : ""); ?>" class="validate[required] input_text_add" /><?php echo form_error('txt_news_name') ?>
					</li>

					<li>
						<label class="label_content_add"><?php echo $info_content['news_alias']; ?></label>
						<input name="txt_news_alias" id="txt_news_alias" type="text" value="<?php echo set_value('txt_news_alias',($info_content['action_name'] == 'update_news') ? element('news_alias',$news,'') : ""); ?>" class="validate[required] input_text_add" /><?php echo form_error('txt_news_alias') ?>
					</li>
					...
					<li <?php echo ($info_content['bool_active']['image']) ? "" : "style='display:none'" ?>>
						...
						<input name="txt_news_img" id="txt_news_img" type="text" value="<?php echo set_value('txt_news_img',($info_content['action_name'] == 'update_news') ? element('news_img',$news,'') : ""); ?>" class="input_text_add_browser"/>
					...
					<li>
						...
						<input name="txt_news_seo_keyword" id="txt_news_seo_keyword" type="text" value="<?php echo set_value('txt_news_seo_keyword',($info_content['action_name'] == 'update_news') ? element('news_seo_keyword',$news,'') : ""); ?>" class="input_text_add" /><?php echo form_error('txt_news_seo_keyword') ?>
					</li>

					<li>
						<label class="label_content_add"><?php echo $info_content['news_seo_description']; ?></label>
						<input name="txt_news_seo_description" id="txt_news_seo_description" type="text" value="<?php echo set_value('txt_news_seo_description',($info_content['action_name'] == 'update_news') ? element('news_seo_description',$news,'') : ""); ?>" class="input_text_add" /><?php echo form_error('txt_news_seo_description') ?>
					</li>
					...
					<li <?php echo ($info_content['bool_active']['active']) ? "" : "style='display:none'" ?>>
						...
						<select name="txt_news_active" id="txt_news_active" class="select_text_add">
							<option value="0" <?php echo set_select('txt_news_active','0',(($info_content['action_name'] == 'update_news') && (element('news_active',$news,'') == 0)) ? TRUE : FALSE); ?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_inactive']; ?></option>
							<option value="1" <?php echo set_select('txt_news_active','1',(($info_content['action_name'] == 'update_news') && (element('news_active',$news,'') == 1)) ? TRUE : FALSE); ?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_active']; ?></option>
						</select>
					</li>
					...
					<li>
						...
						<select name="txt_news_public" id="txt_news_public" class="select_text_add">
							<option value="1" <?php echo set_select('txt_news_public','1',(($info_content['action_name'] == 'update_news') && (element('news_public',$news,'') == 1)) ? TRUE : FALSE); ?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_public']; ?></option>
							<option value="0" <?php echo set_select('txt_news_public','0',(($info_content['action_name'] == 'update_news') && (element('news_public',$news,'') == 0)) ? TRUE : FALSE); ?> >&nbsp;&nbsp;&nbsp;&#187;&nbsp;<?php echo $info_content['admin_hidden']; ?></option>
						</select>
					</li>

					<li>
						<label class="label_content_add"><?php echo $info_content['news_order']; ?></label>
						<input name="txt_news_order" id="txt_news_order" type="text" value="<?php echo set_value('txt_news_order',($info_content['action_name'] == 'update_news') ? element('news_order',$news,'') : ""); ?>" class="validate[required,custom[custom_onlyNumber]] input_text_add" /><?php echo form_error('txt_news_order') ?>
					</li>
					...
					<li <?php echo ($info_content['bool_active']['description']) ? "" : "style='display:none'" ?>>
						...
						<textarea name="txt_news_headline" id="txt_news_headline" ><?php echo set_value('txt_news_headline',($info_content['action_name'] == 'update_news') ? element('news_headline',$news,'') : ""); ?></textarea> 
					...
					<li>
						...
						<textarea class="ckeditor_admin" name="txt_news_content" id="txt_news_content" ><?php echo set_value('txt_news_content',($info_content['action_name'] == 'update_news') ? element('news_content',$news,'') : ""); ?></textarea> 
