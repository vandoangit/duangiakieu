...
?>
<script type="text/javascript" src="<?php echo base_url().ADMIN_DIR_TEMPLATE;?>js/ajax/utility.js"></script>
    ...
    (function($){
        ...
        $.alert_authorization_body = function(){
            ...
            $('#content').delegate('#content .alert_authorization_add','click', function(){
                alert("<?php echo $info_content['alert_authorization_add_utility'];?>");
                return false;
            });
        
            $('#content').delegate('#content .alert_authorization_delete','click', function(){
                alert("<?php echo $info_content['alert_authorization_delete_utility'];?>");
                return false;
            });
        
            $('#content').delegate('#content .alert_authorization_update','click', function(){
                alert("<?php echo $info_content['alert_authorization_update_utility'];?>");
                return false;
            });
            return this;
      };  
...
<div id="content">
    ...
    <form name="form_manager_content" id="form_manager_content" action="" method="post">
        ...
        <tr>
            ...
            <th width="200"><?php echo $info_content['utility_name']?></th>

            <th width="280"><?php echo $info_content['utility_url'] ?></th>

            <th width="65"><?php echo $info_content['utility_public'] ?></th>
            
            <th width="65"><?php echo $info_content['utility_order'] ?></th>

            <th width="70" class="right"><?php echo $info_content['utility_img'] ?></th>
        ...
        <tr>
            ...
            <th><?php echo $info_content['utility_name']?></th>

            <th><?php echo $info_content['utility_url'] ?></th>

            <th><?php echo $info_content['utility_public'] ?></th>
            
            <th><?php echo $info_content['utility_order'] ?></th>

            <th class="right"><?php echo $info_content['utility_img'] ?></th>
            ...
            <tr class="gradeC">
                <td>
                    <div align="center" class="title_table_database">
                        <?php echo element('utility_id',$utility[$i],'');?>
                    </div>
                </td>
                
                <td>
                    <div align="center">
                        <input type="checkbox" name="checkbox[<?php echo element('utility_id',$utility[$i],'');?>]" class="chkCheck" id="check_<?php echo element('utility_id',$utility[$i],'');?>" />
                    </div>
                </td>
                    
                <td>
                    <div align="left" class="title_table_database">
                        <?php echo element('utility_name',$utility[$i],'');?>
                    </div>
                </td>
                
                <td>
                    <div align="left" class="link_table">
                        <a title="<?php echo custom_htmlspecialchars(element('utility_name',$utility[$i],''));?>" target="_blank"  href="<?php echo element('utility_url',$utility[$i],'');?>"><?php echo element('utility_url',$utility[$i],'');?></a>
                    </div>
                </td>
                
                <td>
                    <?php
                        $public=(element('utility_public',$utility[$i],'')==1)?"ajax_public_yes":"ajax_public_no";
                        echo ($authorization['update'])?"<div align='center' class='".$public." ajax_update_public' update_public_param='".element('utility_id',$utility[$i],'')."' >&nbsp;</div> "
                ...
                <td>
                    <?php
                        echo ($authorization['update'])?"<div align='center' class='ajax_update_order_input' update_order_param='".element('utility_id',$utility[$i],'')."' >".element('utility_order',$utility[$i],'')."</div> "
                                                       :"<div align='center'>".element('utility_order',$utility[$i],'')."</div>";
                    ?>
                </td>

                <td>
                    <div align="center">
                        <a class="lightbox_admin"  rel="utility" href="<?php echo base_src_img(element('utility_img',$utility[$i],'')); ?>">
                            <img alt="<?php echo custom_htmlspecialchars(element('utility_name',$utility[$i],'')) ?>" src="<?php echo base_src_img(element('utility_img',$utility[$i],'')); ?>"/>
                        </a>
                    </div>
                </td>
                ...
                <td>
                    <div align="center">
                        <a class="<?php echo ($authorization['update'])?"":"alert_authorization_update" ?>" title="<?php echo $info_content['action_update']?>" href="<?php echo ($authorization['update'])?base_url().ADMIN_DIR_VIRTUAL."/".element('menu_class',$sub_menu['update'],false)."/".element('sub_menu_function',$sub_menu['update'],false)."/".element('utility_id',$utility[$i],''):"#";?>">
                ...
                <td>
                    <div align="center">
                        <a delete_param="<?php echo element('utility_id',$utility[$i],'') ?>" class="<?php echo ($authorization['delete'])?"ajax_delete_item":"alert_authorization_delete"?>" title="<?php echo $info_content['action_delete']?>">
