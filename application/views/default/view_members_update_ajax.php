...
<div id="member_ajax">
    <div class="member_update">
        <div class="body_member_update">

            <div class="caption_member_update">
                <h4><?php echo $info_content['info_user_update'];?></h4>
                <div id="close_member_ajax" class="close_member_ajax">&nbsp;</div>
            </div>

            <form action="" method="post" name="form_member_update_ajax" id="form_member_update_ajax">
                ...
                <div class="content_member_update">
                    <ul>
                        ...
                        <li class="member_update_captcha">
                            ...
                            <span id="ajax_captcha_member_update_ajax"></span><?php echo form_error('txt_member_update_captcha')?>
                        </li>
                    </ul>
                </div>
                ...
                <div class="button_member_update">
                    <div class="body_button_member_update">
                        <a id="submit_member_update_ajax" class="button" title="<?php echo $info_content['button_member_update'];?>"><?php echo $info_content['button_member_update'];?></a>
                        <a id="button_reset_update_ajax" class="button" title="<?php echo $info_content['button_member_reset'];?>"><?php echo $info_content['button_member_reset'];?></a>
                    </div>
                </div>
            </form>
        </div>
