    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
                ...
                <h2><a class="title_page" title="<?php echo custom_htmlspecialchars($info_content['article_search_title']) ?>" href="<?php echo current_url(); ?>"><?php echo $info_content['article_search_title']; ?></a></h2>
            </div>
        </div>
    </div>
