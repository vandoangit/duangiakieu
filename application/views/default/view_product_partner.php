    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
				...
				<h2><a class="title_page" title="<?php echo custom_htmlspecialchars(element('partner_name',$partner,'')); ?>" href="<?php echo current_url(); ?>"><?php echo element('partner_name',$partner,$info_content['message_system_title']); ?></a></h2>
            </div>
        </div>
    </div>
