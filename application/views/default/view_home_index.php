    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
				...
				<h2><a class="title_page" title="<?php echo custom_htmlspecialchars($info_content['home_index_product_prominent']); ?>" href="<?php echo current_url(); ?>"><?php echo ($info_content['home_index_product_prominent'] != '') ? $info_content['home_index_product_prominent'] : $info_content['message_system_title']; ?></a></h2>
            </div>
        </div>
    </div>
        ...
        <div class="content_border_left">
            <div class="content_border_right">
                <div class="list_product">
					...
					if(is_array($product_prominent) && !empty($product_prominent)){

						$i=0;
						foreach($product_prominent as $key=> $value){
