    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
				...
				<h2><a class="title_page" title="<?php echo custom_htmlspecialchars(element('application_name',$application,'')); ?>" href="<?php echo current_url(); ?>"><?php echo element('application_name',$application,$info_content['message_system_title']); ?></a></h2>
            </div>
        </div>
    </div>
