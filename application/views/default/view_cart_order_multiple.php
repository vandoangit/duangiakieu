			...
			<div class="content_border_left">
				<div class="content_border_right">
					<div id="module_cart" class="cart_order">
						...
						<div class="cart_order_product" id="module_cart_ajax_content">
							<?php
                        ...
                        <table cellspacing="0px" cellpadding="0px">
                            <thead>
                                <tr>
                                    ...
                                    <th width="25%">
										<?php echo $info_content['cart_order_product_subtotal']; ?>
                                    </th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
								...
								if(is_array($product_cart) && !empty($product_cart)){
									...
									foreach($product_cart as $key=> $value){
										...
										<tr>
											<td>
												...
												<div align="center">
													<a class="ajax_delete_cart" delete_param="<?php echo element('rowid',$value,''); ?>" title="<?php echo $info_content['cart_order_product_delete']; ?>"><?php echo $info_content['cart_order_product_delete']; ?></a>
												</div>
											</td>
											...
											<td>
												<div align="center" class="cart_order_subtotal">
									...
									?>
									<tr>
										<td colspan="4" class="cart_order_empty">
								...
								?>
                                <tr>
                                    <td colspan="4" class="cart_order_total">
										<?php echo $info_content['cart_order_product_total']; ?>:&nbsp;<?php echo number_format($this->custom_cart->total_money_cart(),0,',','.').'<sup>'.CURRENCY_UNIT.'</sup>'; ?>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
