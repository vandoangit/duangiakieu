    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
				...
				<h2><a class="title_page" title="<?php echo custom_htmlspecialchars($info_content['product_search_title']) ?>" href="<?php echo current_url(); ?>"><?php echo $info_content['product_search_title']; ?></a></h2>
            </div>
        </div>
    </div>
            ...
            <div class="content_border_right">
                <div class="list_product">
					...
					if(is_array($product) && !empty($product)){
						...
						echo "<div class='system_update'>".$info_content['message_system_search']."</div>";
					}
