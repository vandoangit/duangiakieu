    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
                ...
                <h2><a class="title_page" title="<?php echo custom_htmlspecialchars(element('news_name',$customer,'')) ?>" href="<?php echo current_url(); ?>"><?php echo element('news_name',$customer,$info_content['introduce_customer_title']) ?></a></h2>
            </div>
        </div>
    </div>
                ...
                <div class="detail_news">
					...
					if(is_array($customer) && !empty($customer)){
						...
						<div class="detail_news_content">
							<?php echo element('news_content',$customer,''); ?>
						</div>
						<?php
