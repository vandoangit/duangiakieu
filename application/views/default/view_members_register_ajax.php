...
<div id="member_ajax">
    <div class="member_register">
        <div class="body_member_register">

            <div class="caption_member_register">
                <h4><?php echo $info_content['info_user_register'];?></h4>
                <div id="close_member_ajax" class="close_member_ajax">&nbsp;</div>
            </div>

            <form action="" method="post" name="form_member_register_ajax" id="form_member_register_ajax">
                ...
                <div class="content_member_register">
                    <ul>
                        ...
                        <li class="member_register_captcha">
                            ...
                            <span id="ajax_captcha_member_register_ajax"></span><?php echo form_error('txt_member_register_captcha')?>
                        </li>
                    </ul>
                </div>
                ...
                <div class="button_member_register">
                    <div class="body_button_member_register">
                        <a id="submit_member_register_ajax" class="button" title="<?php echo $info_content['button_member_register'];?>"><?php echo $info_content['button_member_register'];?></a>
                        <a id="button_reset_register_ajax" class="button" title="<?php echo $info_content['button_member_reset'];?>"><?php echo $info_content['button_member_reset'];?></a>
                    </div>
                </div>
            </form>
        </div>
