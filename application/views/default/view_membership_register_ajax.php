...
?>
<form action="" method="post" name="form_membership_register" id="form_membership_register_ajax">
    ...
    <div class="content_membership_register">
        <ul>
            ...
            <li class="membership_register_captcha">
                ...
                <span id="ajax_captcha_membership_register_ajax"></span><?php echo form_error('txt_membership_register_captcha')?>
            </li>
        </ul>
    </div>
    ...
    <div class="button_membership_register">
        <div class="body_button_membership_register">
            <a id="submit_membership_register_ajax" class="button" title="<?php echo $info_content['button_membership_register'];?>"><?php echo $info_content['button_membership_register'];?></a>
            <a id="button_reset_membership_ajax" class="button" title="<?php echo $info_content['button_membership_reset'];?>"><?php echo $info_content['button_membership_reset'];?></a>
        </div>
    </div>
</form>