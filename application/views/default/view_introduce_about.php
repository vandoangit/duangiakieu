    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
                ...
                <h2><a class="title_page" title="<?php echo custom_htmlspecialchars($info_content['introduce_about_title']) ?>" href="<?php echo current_url(); ?>"><?php echo $info_content['introduce_about_title'] ?></a></h2>
            </div>
        </div>
    </div>
        ...
        <div class="content_border_left">
            <div class="content_border_right">
                <div class="detail_news">
					...
					if(is_array($introduce) && !empty($introduce)){

						?>
						<div class="detail_news_content">
							<?php echo element('news_content',$introduce,''); ?>
						</div>
						<?php
