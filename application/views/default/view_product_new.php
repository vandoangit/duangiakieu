	...
	<div class="module_left">
		<div class="title_border_center">
			<div class="title_border_left">
				<div class="title_border_right"><?php echo $info_product_new['product_new_module_title'] ?></div>
			</div>
		</div>
		...
		<div class="content_border_center">
			<div class="content_border_left">
				<div class="content_border_right">
					<div id="module_product_new" class="list_product_new_vertical">
						<?php
