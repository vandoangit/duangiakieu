    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
                ...
                <h2><a class="title_page" title="<?php echo custom_htmlspecialchars(element('news_name',$news_one,'')); ?>" href="<?php echo current_url(); ?>"><?php echo (element('news_name',$news_one,'') != '') ? element('news_name',$news_one,'') : $info_content['news_detail_title']; ?></a></h2>
            </div>
        </div>
    </div>
        ...
        <div class="content_border_left">
            <div class="content_border_right">
				...
				if(is_array($news) && !empty($news)){
					...
					?>
					<div class="news_involved_sidebar">
