...
echo card_load_js_setting('card_setting_facebook_themedefault');
?>
    ...
    <div class="title_border_center">
        <div class="title_border_left">
            <div class="title_border_right">
                <a  title="<?php echo custom_htmlspecialchars($info_content['facebook_themedefault_title'])?>" href="<?php echo current_url()."/";?>"><?php echo $info_content['facebook_themedefault_title']?></a>
            </div>
        </div>
    </div>
