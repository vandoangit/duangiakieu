...
var ddsmoothmenu={
    ...
    arrowimages:{
        down:['downarrowclass',"down.png",23],
        right:['rightarrowclass',"right.png"]
    },
    transition:{
        overtime:300,
        outtime:300
    ...
    buildmenu:function($,setting){
        ...
        if($mainmenu.parent().get(0) == undefined)
            return false;
        $mainmenu.parent().get(0).className=setting.classname || "ddsmoothmenu"
        var $headers=$mainmenu.find("ul").parent()
        smoothmenu.arrowimages=(setting.arrowimages == undefined) ? smoothmenu.arrowimages : setting.arrowimages;
