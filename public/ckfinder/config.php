...
*/
//$baseUrl = 'http://gialang.totalh.com/hinh/';
//$baseUrl = 'http://nguoidaklak.net/';
$baseUrl = '/upload/';
...
ATTENTION: The trailing slash is required.
*/
//$baseDir ='/home/vol9/byethost5.com/b5_6912439/gialang.totalh.com/htdocs/hinh/';
//$baseDir ='/home/vol9/byethost5.com/b5_6912439/nguoidaklak.net/htdocs/'; 
$baseDir = resolveUrl($baseUrl);
/*
 * ### Advanced Settings
 */
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'bmp,gif,jpeg,jpg,png,avi,iso,mp3,swf,mp4,flv',
		'deniedExtensions' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'swf,flv,mp4,mp3',
		'deniedExtensions' => '');
